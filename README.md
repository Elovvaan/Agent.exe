...
- Execution now routes through internal agent roles:
  - `PLANNER_AGENT` (deterministic step routing)
  - `GENERATOR_AGENT` (description/CTA proposals)
  - `EVALUATOR_AGENT` (validation + scoring gate)
  - `OPTIMIZER_AGENT` (conditional recovery suggestions)
